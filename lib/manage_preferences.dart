...
/// Preferences related
///
const String _storageKey = "UToken_";
...
class GlobalPreferences {
  ...
  /// ----------------------------------------------------------
  /// Method that saves/restores the preferred user token
  /// ----------------------------------------------------------
  getPreferredToken() async {
    return _getApplicationSavedInformation('token');
  }
  setPreferredToken(String token) async {
  ...
  getWalletPrivateKey() async {
    return _getApplicationSavedInformation('private_key');
  }
  setWalletPrivateKey(String token) async {
    return _setApplicationSavedInformation('private_key', token);
  }
  ...
  getWalletPublicKey() async {
    return _getApplicationSavedInformation('public_key');
  }
  setWalletPublicKey(String token) async {
    return _setApplicationSavedInformation('public_key', token);
  }
  ...
  /// ----------------------------------------------------------
  /// Method that saves/restores the preferred username
  /// ----------------------------------------------------------
  getPreferredUsername() async {
    return _getApplicationSavedInformation('username');
  }
  setPreferredUsername(String username) async {
    return _setApplicationSavedInformation('username', username);
  }
  ...
  /// Singleton Factory
  ///
  static final GlobalPreferences _globalPreferences = new GlobalPreferences._internal();
...
GlobalPreferences managePreferences = new GlobalPreferences();